    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            if (head_back_x <= nose_x + int(20 * scaling_factor)):
                ...
                cv2.line(frame, p1, p0, outer_color, int(20 * scaling_factor * 1.5))
                ...
                cv2.line(frame, p1, p2, outer_color, int(20 * scaling_factor* 1.5))
                cv2.line(frame, p2, p3, outer_color, int(20 * scaling_factor* 1.5))
                cv2.line(frame, p3, p4, outer_color, int(20 * scaling_factor* 1.5))
                cv2.line(frame, p4, p5, outer_color, int(20 * scaling_factor* 1.5))
                cv2.line(frame, p5, p6, outer_color, int(20 * scaling_factor* 1.5))
                cv2.line(frame, p6, p7, outer_color, int(20 * scaling_factor* 1.5))
                ...
                cv2.line(frame, p0, p1, outer_color, int(20 * scaling_factor* 1.5))
